...
public class LockUnitTests {
	...
	public static void doOp(String siteId, String key, String value, ShareableLock lock, long sleepBeforeCommit) throws Exception {
		List<ResourceRequest<?>> resources = new LinkedList<ResourceRequest<?>>();
	...
	public static void doThreadOp(final String siteId, final String key, final String value, final ShareableLock lock, final long sleepBeforeCommit) {
