...
FILES=$RES_DIR/results-weak-R5-W2-k1000-r3-t*-v2999999-uniform*/TPSL/*ALL*
java -classpath ./bin/:./TrueIndigo/lib/* evaluation.StatisticsUtils -tpsa -t $FILES > tmp_unsorted && sort -n tmp_unsorted  > $DATA_DIR/TPS_T-R5-W2-k1000-r3-v2999999-weak-ALL.dat

FILES=$RES_DIR/results-weak-R5-W3-k1000-r3-t*-v2999999-uniform*/TPSL/*ALL*
java -classpath ./bin/:./TrueIndigo/lib/* evaluation.StatisticsUtils -tpsa -t $FILES > tmp_unsorted && sort -n tmp_unsorted  > $DATA_DIR/TPS_T-R5-W3-k1000-r3-v2999999-weak-ALL.dat
...
gnuplot -e "iallr5w1='$DATA_DIR/TPS_T-R5-W1-k1000-r3-v2999999-indigo-ALL.dat'"\
		...
		-e "wallr5w1='$DATA_DIR/TPS_T-R5-W1-k1000-r3-v2999999-weak-ALL.dat'"\
		-e "wallr5w2='$DATA_DIR/TPS_T-R5-W2-k1000-r3-v2999999-weak-ALL.dat'"\
		-e "wallr5w3='$DATA_DIR/TPS_T-R5-W3-k1000-r3-v2999999-weak-ALL.dat'"\
			plot_generator/TPS_Threads_Multi_ALL-WRITES-CMP.gnuplot > $OUT_DIR/TPS_T-R5-W-k1000-r3-ALL-CMP.ps
