...
plot    iallr5w1 using 1:2  every ::1 title "Indigo R5-W1" with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb 'red',\
        iallr5w2 using 1:2  every ::1 title "Indigo R5-W2" with linespoints pi 1 lt 1 ps 2 pt 4 lc rgb 'red',\
        iallr5w3 using 1:2  every ::1 title "Indigo R5-W3" with linespoints pi 1 lt 1 ps 2 pt 6 lc rgb 'red',\
        wallr5w1 using 1:2  every ::1 title "Weak R5-W1" with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb 'blue',\
        wallr5w2 using 1:2  every ::1 title "Weak R5-W2" with linespoints pi 1 lt 1 ps 2 pt 4 lc rgb 'blue',\
        wallr5w3 using 1:2  every ::1 title "Weak R5-W3" with linespoints pi 1 lt 1 ps 2 pt 6 lc rgb 'blue';
