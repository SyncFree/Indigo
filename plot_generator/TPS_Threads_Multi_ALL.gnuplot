...
plot    iall using 1:2  every ::1 title "Indigo: 3 Regions" with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb '#000000',\
        wall using 1:2  every ::1 title "Causal: 3 Regions" with linespoints pi 1 lt 2 ps 2 pt 4 lc rgb '#444444',\
        sall using 1:2  every ::1 title "Strong: 1 Regions" with linespoints pi 1 lt 3 ps 2 pt 6 lc rgb '#1F1F1F';
