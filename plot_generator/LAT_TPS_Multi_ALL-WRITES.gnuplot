...
plot    iallr5w1 using 2:3   every ::1 title "Indigo R5-W1" with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb '#000000',\
        iallr5w2 using 2:3   every ::1 title "Indigo R5-W2" with linespoints pi 1 lt 1 ps 2 pt 4 lc rgb '#0F0F0F',\
        iallr5w3 using 2:3   every ::1 title "Indigo R5-W3" with linespoints pi 1 lt 1 ps 2 pt 6 lc rgb '#030303';
