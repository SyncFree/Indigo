...
do
	...
	do
		:
			awk -F '\t' '{if (NR==13) START=$2} {if (length(START) != 0) print $2-START" "$4}' $f >> $dir/micro_benchmark_results_ALL.log_tmp 
	done
...
FILES=$RES_DIR/results-strong-k1000-r3-t*-v2999999-uniform/TPSL/*ALL.dat
