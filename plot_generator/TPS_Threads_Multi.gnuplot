...
plot    iuse using 1:2  every ::1 title "Indigo: US-E"  with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb '#000000',\
        iusw using 1:2  every ::1 title "Indigo: US-W"  with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb '#0F0F0F',\
        ieur using 1:2  every ::1 title "Indigo: EUR"   with linespoints pi 1 lt 1 ps 2 pt 2 lc rgb '#444444',\
        wuse using 1:2  every ::1 title "Causal: US-E"  with linespoints pi 1 lt 2 ps 2 pt 4 lc rgb '#000000',\
	    wusw using 1:2  every ::1 title "Causal: US-W"  with linespoints pi 1 lt 2 ps 2 pt 4 lc rgb '#0F0F0F',\
        weur using 1:2  every ::1 title "Causal: EUR"   with linespoints pi 1 lt 2 ps 2 pt 4 lc rgb '#444444';
